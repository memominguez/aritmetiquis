...
function Sumar() {
  ...
  const [halftime, setHalftime] = useState(false); // check when 60% ellapsed
  ...
  const generateNums = () => {
    setNum1(Math.floor(Math.random() * 98) + 2);
  ...
  return (
    <>
      {counter >= trialsNumber ? (
        <div className="container" style={{ backgroundColor: "#4949ff" }}>
